...
//                memset(dma_rx_buffer[current_rx_buffer], 0, sizeof(dma_rx_buffer[current_rx_buffer]));
//                // 将解码后的角度值写入队列
...
//            }
//            // 写入队列
//            if (xQueueSend(xUARTQueue, referee_rx_buffer[referee_rx_buffer_index], 0) == pdTRUE) {
