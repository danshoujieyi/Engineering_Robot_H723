...
//
///* 斜坡控制参数 */
//#define KEY_ACC_TIME     1700  // 加速时间(ms)
//#define GIMBAL_PERIOD    10    // 控制周期(ms)
//
//
//int16_t delta_spd = MAX_CHASSIS_VX_SPEED*1.0f/KEY_ACC_TIME*GIMBAL_PERIOD;
//int16_t delta_spd_rot = MAX_CHASSIS_VW_SPEED*1.0f/KEY_ACC_TIME*GIMBAL_PERIOD;
//
///* 宏定义 */
//#define CHASSIS_PC_MOVE_RATIO_X   1.0f  // 键盘X轴平移系数
//#define CHASSIS_PC_MOVE_RATIO_Y   1.0f  // Y轴平移系数
//#define CHASSIS_PC_MOVE_RATIO_R   1.0f  // 旋转系数
//#define MAX_CHASSIS_VX_SPEED      3000  // mm/s
//#define MAX_CHASSIS_VY_SPEED      3000
//#define MAX_CHASSIS_VW_SPEED      1500
...
//
//    /* 模式切换保护 */
//    if(chassis_cmd.ctrl_mode != last_ctrl_mode) {
//        chassis_cmd.last_mode = last_ctrl_mode;
//        last_ctrl_mode = chassis_cmd.ctrl_mode;
//    }
}
