...
void dm_motor_init(void)
{
    ...
    motor[Motor1].ctrl.mode = pos_mode; // 设置为位置速度模式
    motor[Motor1].ctrl.vel_set = 0.5f;  // 默认速度
    ...
    motor[Motor2].ctrl.vel_set = 0.5f;
    ...
    motor[Motor3].ctrl.vel_set = 0.5f;
    ...
    motor[Motor4].ctrl.vel_set = 0.5f;
    ...
    motor[Motor5].ctrl.vel_set = 0.5f;
    ...
    motor[Motor6].ctrl.vel_set = 0.5f;
